...
const categorizeFeaturesByWorkflow = (
  features: string[],
  projectTypes: string[],
  categories: string[],
) => {
  ...
  features.forEach((feature) => {
    ...
    if (
      ...
      lowerFeature.includes("register") ||
      lowerFeature.includes("auth") ||
      lowerFeature.includes("signup") ||
      lowerFeature.includes("social") ||
      lowerFeature.includes("password") ||
      lowerFeature.includes("authentication") ||
      lowerFeature.includes("sign")
    ) {
      workflows["WORKFLOW 1: USER ENTRY & AUTHENTICATION"].push(feature);
    }
    // Workflow 2: User Profile & Content Interaction
    else if (
      lowerFeature.includes("profile") ||
      lowerFeature.includes("user") ||
      lowerFeature.includes("role") ||
      lowerFeature.includes("permission") ||
      lowerFeature.includes("content") ||
      lowerFeature.includes("create") ||
      lowerFeature.includes("edit") ||
      lowerFeature.includes("delete")
    ) {
    ...
    // Workflow 3: UI, Responsiveness & Experience
      ...
      lowerFeature.includes("dark") ||
      lowerFeature.includes("light") ||
      lowerFeature.includes("responsive") ||
      lowerFeature.includes("mobile") ||
      lowerFeature.includes("tablet") ||
      lowerFeature.includes("desktop") ||
      lowerFeature.includes("animation") ||
      lowerFeature.includes("transition") ||
      lowerFeature.includes("ui") ||
      lowerFeature.includes("ux")
    ) {
    ...
    // Workflow 4: Backend, APIs & System Integration
      ...
      lowerFeature.includes("server") ||
      lowerFeature.includes("integration") ||
      lowerFeature.includes("rest") ||
      lowerFeature.includes("graphql") ||
      lowerFeature.includes("security") ||
      lowerFeature.includes("token") ||
      lowerFeature.includes("encryption") ||
      lowerFeature.includes("cms")
    ) {
      workflows["WORKFLOW 4: BACKEND, APIs & SYSTEM INTEGRATION"].push(feature);
    }
    // Workflow 5: E-Commerce & Transaction Flow
    else if (
      lowerFeature.includes("payment") ||
      lowerFeature.includes("cart") ||
      lowerFeature.includes("checkout") ||
      lowerFeature.includes("ecommerce") ||
      lowerFeature.includes("shop") ||
      lowerFeature.includes("product") ||
      lowerFeature.includes("order") ||
      lowerFeature.includes("catalog") ||
      lowerFeature.includes("transaction")
    ) {
      workflows["WORKFLOW 5: E-COMMERCE & TRANSACTION FLOW"].push(feature);
    }
    // Workflow 6: Content Management & Publishing
    else if (
      lowerFeature.includes("blog") ||
      lowerFeature.includes("media") ||
      lowerFeature.includes("upload") ||
      lowerFeature.includes("versioning") ||
      lowerFeature.includes("language") ||
      lowerFeature.includes("publishing") ||
    ...
    // Workflow 7: Analytics, SEO & Optimization
      ...
      lowerFeature.includes("seo") ||
      lowerFeature.includes("tracking") ||
      lowerFeature.includes("monitoring") ||
      lowerFeature.includes("report") ||
      lowerFeature.includes("metrics") ||
      lowerFeature.includes("testing") ||
      lowerFeature.includes("optimization") ||
      ...
      <View style={styles.table}>
        ...
        {features.map((feature, index) => (
          <View key={index} style={styles.tableRow}>
            ...
            <Text style={styles.expectationCell}>
              Implementation of {feature.toLowerCase()} functionality
            </Text>
            <Text style={[styles.priorityCell, priorityStyle]}>
              {priority || "Medium"}
            </Text>
          </View>
        ))}
...
export const ProjectRequirementPDF = (data: ContactFormData) => {
  const categorizedFeatures = categorizeFeaturesByWorkflow(
    data.features || [],
    data.projectTypes || [],
    data.categories || [],
  );
  ...
  const workflowDescriptions = {
    "WORKFLOW 1: USER ENTRY & AUTHENTICATION":
      "This category defines how users enter system, create accounts, and authenticate securely. These features are mandatory for any user-based platform and form foundation of all other workflows.",
    "WORKFLOW 2: USER PROFILE & CONTENT INTERACTION":
      "This category covers what users can do after logging in, including interacting with or generating content.",
    "WORKFLOW 3: UI, RESPONSIVENESS & EXPERIENCE":
      "This category ensures application is visually usable, accessible, and device-independent.",
    "WORKFLOW 4: BACKEND, APIs & SYSTEM INTEGRATION":
      "This category defines how frontend communicates with backend systems, including data exchange and security.",
    "WORKFLOW 5: E-COMMERCE & TRANSACTION FLOW":
      "This category applies only if monetization or product selling is required.",
    "WORKFLOW 6: CONTENT MANAGEMENT & PUBLISHING":
      "This category defines how static and dynamic content is created and managed.",
    "WORKFLOW 7: ANALYTICS, SEO & OPTIMIZATION":
      "This category helps client measure performance and improve visibility.",
  };
    ...
    <Document>
      ...
      <Page size="A4" style={styles.coverPage}>
        ...
        <Text style={styles.subtitle}>
          Workflow-Based Feature Categorization for Web Application
        </Text>
        ...
        <Text style={styles.documentInfo}>
          Document generated on {new Date().toLocaleDateString()} • Confidential
          & Proprietary
        </Text>
      </Page>
      ...
      <Page size="A4" style={styles.page}>
        ...
        <WorkflowFeatureTable
          ...
          description={
            workflowDescriptions["WORKFLOW 1: USER ENTRY & AUTHENTICATION"]
          }
          features={
            categorizedFeatures["WORKFLOW 1: USER ENTRY & AUTHENTICATION"]
          }
          priority="High"
        />
        ...
        <WorkflowFeatureTable
          ...
          description={
            workflowDescriptions["WORKFLOW 3: UI, RESPONSIVENESS & EXPERIENCE"]
          }
          features={
            categorizedFeatures["WORKFLOW 3: UI, RESPONSIVENESS & EXPERIENCE"]
          }
          priority="High"
        />
        ...
        <WorkflowFeatureTable
          ...
          description={
            workflowDescriptions["WORKFLOW 5: E-COMMERCE & TRANSACTION FLOW"]
          }
          features={
            categorizedFeatures["WORKFLOW 5: E-COMMERCE & TRANSACTION FLOW"]
          }
          priority="High"
        />
        ...
        <WorkflowFeatureTable
          ...
          description={
            workflowDescriptions["WORKFLOW 6: CONTENT MANAGEMENT & PUBLISHING"]
          }
          features={
            categorizedFeatures["WORKFLOW 6: CONTENT MANAGEMENT & PUBLISHING"]
          }
          priority="Medium"
        />
        ...
        <WorkflowFeatureTable
          ...
          description={
            workflowDescriptions["WORKFLOW 7: ANALYTICS, SEO & OPTIMIZATION"]
          }
          features={
            categorizedFeatures["WORKFLOW 7: ANALYTICS, SEO & OPTIMIZATION"]
          }
          priority="Medium"
        />
        ...
        <View style={styles.overviewTable}>
          <View style={styles.tableRow}>
            ...
            <Text style={styles.overviewValue}>
              {data.budget || "To be finalized after consultation"}
            </Text>
          </View>
          <View style={styles.tableRow}>
        ...
        <View style={styles.notesSection}>
          ...
          <Text style={styles.notesText}>
            This PRD will be considered approved when: • All features are
            grouped by workflow • Each table clearly explains what is expected •
            Priorities are agreed upon • No feature ambiguity remains before
            quotation or development
          </Text>
        </View>
        ...
        <View style={styles.confidentialityBox}>
          ...
          <Text style={styles.confidentialityText}>
            This document contains confidential information and is intended
            solely for use of the individual or entity to whom it is addressed.
        ...
        <Text style={styles.footer}>
          This document contains confidential information and is intended solely
